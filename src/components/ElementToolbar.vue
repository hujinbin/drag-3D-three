...
<template>
  <div class="bg-gray-100 p-4 shadow-lg h-full flex flex-col">
...
const presetModels = ref([
  ...
  { id: 'sofa', name: '沙发', url: '/models/sofa.glb' },
  { id: 'bed', name: '床', url: '/models/bed.glb' },
  { id: 'cabinet', name: '柜子', url: '/models/cabinet.glb' },
  { id: 'monitor', name: '显示器', url: '/models/monitor.glb' },
  { id: 'keyboard', name: '键盘', url: '/models/keyboard.glb' }
])
